    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(related_name='items', to='shop.Cart', on_delete=models.SET_NULL)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(related_name='extra_info', verbose_name='Order', to='shop.Order', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(related_name='items', verbose_name='Order', to='shop.Order', on_delete=models.CASCADE)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', shop.util.fields.CurrencyField(default=Decimal('0.0'), verbose_name='Unit price', max_digits=30, decimal_places=2)),
                ('polymorphic_ctype', models.ForeignKey(related_name='polymorphic_shop.product_set+', editable=False, to='contenttypes.ContentType', null=True, on_delete=models.SET_NULL)),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(verbose_name='Order', to='shop.Order',on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='extraorderitempricefield',
            name='order_item',
            field=models.ForeignKey(verbose_name='Order item', to='shop.OrderItem',on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='cartitem',
            name='product',
            field=models.ForeignKey(to='shop.Product',on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='address',
            name='country',
            field=models.ForeignKey(verbose_name='Country', blank=True, to='shop.Country', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='address',
            name='user_billing',
            field=models.OneToOneField(related_name='billing_address', null=True, blank=True, to=settings.AUTH_USER_MODEL, on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='address',
            name='user_shipping',
            field=models.OneToOneField(related_name='shipping_address', null=True, blank=True, to=settings.AUTH_USER_MODEL, on_delete=models.SET_NULL),
        ),
    ]
